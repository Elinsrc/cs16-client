...
EXTERN void ( APIENTRY *pglRotated )(GLdouble anpgle, GLdouble x, GLdouble y, GLdouble z);
EXTERN void ( APIENTRY *pglRotatef )(GLfloat anpgle, GLfloat x, GLfloat y, GLfloat z);
